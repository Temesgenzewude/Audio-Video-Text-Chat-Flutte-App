...
//       if(text.isNotEmpty){
//         widgets.add(TextSpan(text: text,style: TextStyle(fontSize: 14.sp, color: AppColors.primaryText)));
//       }
//       return '';
//     },
//   );
...
//               ),
//               child:item.type=="text"?LeftRichTextContainer("${item.content}"):ConstrainedBox(
