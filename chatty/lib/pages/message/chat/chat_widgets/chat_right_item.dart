...
//       if(text.isNotEmpty){
//         widgets.add(TextSpan(text: text,style: TextStyle(fontSize: 14.sp, color: AppColors.primaryElementText,)));
//       }
//       return '';
//     },
//   );
...
//               ),
//               child: item.type=="text"?RightRichTextContainer("${item.content}"):ConstrainedBox(
//                   constraints: BoxConstraints(
//                     maxWidth: 90.w, //
//                   ),
