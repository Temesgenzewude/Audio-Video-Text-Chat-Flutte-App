...
class AccessTokenController extends Controller
{
    ...
    public function get_rtc_token(Request $request)
    {
        ...
        $accessToken = new AccessToken2($appID, $appCertificate, $expirationTimeInSeconds);
        $serviceRtc = new ServiceRtc($channelName, $uid);

        $serviceRtc->addPrivilege(ServiceRtc::PRIVILEGE_JOIN_CHANNEL, $expirationTimeInSeconds);
